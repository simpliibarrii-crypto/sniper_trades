...
_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "purpose": "Optional desktop MCP for market data, account read-only access, and paper trading.",
        "mode": "manual · disabled by default",
        "priority": 9,
        "default_status": "client_required",
        "capabilities": ["market data", "account read-only", "paper trading"],
    ...
    },
    {
        ...
        "name": "Raven Chrome Extension",
        "category": "Agent bridge",
        "purpose": "Show a live Raven badge and auditable read-only snapshot from the local FastAPI server.",
        "mode": "localhost read only",
        "priority": 9,
        "default_status": "available",
        "capabilities": ["health", "signal badge", "market snapshot", "tool evidence"],
